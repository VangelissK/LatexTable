...
<li>First argument must be the number of decimal places you want the table's data to have. It can be a vector, for different number of decimal places in each column, or a single number for a universal number of decimal places accross all columns
